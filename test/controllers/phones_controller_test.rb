...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { description: @phone.description, name: @phone.name, picture: @phone.picture }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { description: @phone.description, name: @phone.name, picture: @phone.picture }
    assert_redirected_to phone_path(assigns(:phone))
  end
